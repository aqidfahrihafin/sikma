<?php $no = 0;
    foreach ($tbl_mahasiswa as $p) : $no++; ?>
        <div id="Editmahasiswa<?php echo $p['id_mahasiswa'] ; ?>" class="modal fade" style="display: none;">
                        ...
                        <!-- alamat id -->
                            ...
                            foreach ($tbl_alamat as $alamat) { ?>
                                <?php if ($alamat['nim_mahasiswa'] ==  $p['nim']) { ?>									
                                    <input type="hidden" class="form-control" id="id_alamat" name="id_alamat" required  value="<?php echo $alamat['id_alamat']; ?>">                      
                                    <div class="form-group">

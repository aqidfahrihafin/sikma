...
<head>
	...
	<!-- MIDTRANS -->
	<script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-ycWmIuUZYZGTZRNL"></script>
...
<body>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown navbar-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="hidden-xs"><span class="text-warning">SIKMA </span><?php echo $this->session->userdata('level') ?></span> <span	class="text-warning"><i class="fa fa-caret-down"></i></span>
						</a>
						<ul class="dropdown-menu animated fadeInLeft">
							<li class="arrow"></li>
							<li><a href="<?php echo base_url('dashboard/logout/'); ?>" ><i	class="ion-ios-locked"></i> &nbsp;Logout</a></li>
						</ul>
					</li>
				</ul>
	...
	<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;">
		<div data-scrollbar="true" data-height="100%" data-init="true"
			...
			<!-- begin sidebar nav -->
			<ul class="nav">
				<li class="nav-header">Navigation <i class="fa fa-paper-plane m-l-5"></i>
				...
				<?php if ($this->session->userdata('level') == "Akademik") {   ?>
					<?php $this->load->view('backend/akademik/template/menu/m_akademik'); ?>
				<?php } ?>

				<?php if ($this->session->userdata('level') == "Keuangan") {   ?>
					<?php $this->load->view('backend/akademik/template/menu/m_keuangan'); ?>
				<?php } ?>

				
				
				<!-- begin sidebar minify button -->
			<li	li><a href="javascript:;" class="sidebar-minify-btn grey" data-click="sidebar-minify"><i class="ion-ios-arrow-left"></i> <span>Collapse</span></a></li>
